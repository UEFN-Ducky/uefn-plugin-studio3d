#!/usr/bin/env python3
"""Zip + publish studio3d to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1: 3D AI Studio MCP + skill"
"""
...
def publish(zip_path: Path, *, category: str, changelog: str) -> None:
    ...
    release_args: dict = {
        ...
        "tags": ["3daistudio", "3d", "mesh", "mcp", "ai", "tripo", "trellis"],
    }
    if file_id:
